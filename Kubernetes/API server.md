You can think of the API server as the front end to your Kubernetes [[Cluster]]'s [[control lane AKA master node]]. All the communication between the components in Kubernetes is done through this API.
